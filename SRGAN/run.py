...
if application_name == ApplicationName.age:
    ...
    settings_.batch_size = 60
    settings_.unlabeled_dataset_size = 50000
    settings_.labeled_dataset_size = [600]
    ...
    settings_.matching_loss_multiplier = 1e1
    settings_.contrasting_loss_multiplier = 1e1
    ...
    settings_.crowd_dataset = CrowdDataset.ucf_cc_50
...
settings_.summary_step_period = 2000
settings_.labeled_dataset_seed = 0
settings_.steps_to_run = 15001
...
settings_.save_step_period = 2000
